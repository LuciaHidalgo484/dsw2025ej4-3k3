...
public class Herbivoro extends Mamifero{
    ...
    public Herbivoro(int edad, double peso, Especie especie, Sector sector, double valorFijo, PaisOficial pais) throws InvalidPropertiesFormatException {
    ...
    public double calcularCantidadDeComida() {
        double comida = getPeso() * porcentajePeso + valorFijo;
        return comida;
    }
